      ...
      >
        ...
        <div className="flex items-center justify-end">
          <button
            disabled={!isNotRobot}
            type="submit"
            className="text-sm disabled:bg-red-400 px-3 py-1 bg-gray-500 text-gray-50 rounded-md hover:bg-gray-600 duration-200 ease-out active:translate-y-2 shadow-lg"
            value="Send"
          >
            Send Mail
          </button>
